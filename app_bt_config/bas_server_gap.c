...
#include "bas_server_gap.h"

/* Device address */
wiced_bt_device_address_t cy_bt_device_address = {0x00, 0xA0, 0x50, 0x00, 0x00, 0x00};

const uint8_t cy_bt_adv_packet_elem_0[1] = { 0x06 };
const uint8_t cy_bt_adv_packet_elem_1[14] = { 0x42, 0x61, 0x74, 0x74, 0x65, 0x72, 0x79, 0x20, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72 };
const uint8_t cy_bt_adv_packet_elem_2[2] = { 0x00, 0x18 };
const uint8_t cy_bt_adv_packet_elem_3[2] = { 0x00, 0x00 };
